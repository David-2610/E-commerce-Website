...
const Footer = () => {
	return (
		<footer className="border-t border-t-gray-300 py-12">
			<div className="container mx-auto grid grid-cols-4 md:grid-cols-4 gap-8 px-4 lg:px-0">
				<div>
				...
				<div>
					...
					<p>
						<FiPhoneCall className="inline-block mr-5" />
						0724-123-146
					</p>
				</div>
			</div>
			<div className=" pt-6 container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-300">
